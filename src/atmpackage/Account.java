...
public class Account {
    ...
    private double calculateCheckingBalanceAfterWithdraw(double amount){
        ...
        checkingBalance = checkingBalance - amount;//When user wants to withdraw money their balance ll be updated
        return checkingBalance;
    }
    ...
    public void getCheckingWithdraw(){
        ...
        if (amount<=0){
            ...
            System.out.println("You do not have enough on your checking account");
        }
    }
    ...
    public void getSavingWithdraw(){
        ...
        if (amount<=0){
            System.out.println("Negative or Zero amount is not acceptable");
            getSavingWithdraw();//Recursive Method
